...
public class BackPropagationNetTwoLayer  {
    ...
    public static void main(String[] args) throws IOException {
        ...
        outStreamS9.write(("Start Train 9 sorted study groups- Two layers").getBytes());
		...
		outStreamS15.write(("Start Train 15 sorted study groups- Two layers").getBytes());
		...
		outStreamR4.write(("Start Train 4 random study groups- Two layers").getBytes());
		...
		outStreamR9.write(("Start Train 9 random study groups- Two layers").getBytes());
		...
		outStreamR15.write(("Start Train 15 random study groups- Two layers").getBytes());
